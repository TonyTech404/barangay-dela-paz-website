...
export const metadata: Metadata = {
  ...
  description:
    "Emergency hotlines, evacuation centers, and disaster preparedness information for Barangay Dela Paz residents. Quick access to Barangay Tanod, Police, Fire Department, and Health Center contacts.",
  keywords: [
    "emergency contacts",
    "barangay tanod",
    "police hotline",
  ...
  openGraph: {
    title: "Emergency Contacts & Safety Information | Barangay Dela Paz",
    description:
      "Emergency hotlines, evacuation centers, and disaster preparedness information for Barangay Dela Paz residents.",
...
export default function EmergencyPage() {
  return (
    <>
      {/* Structured Data for Emergency Page */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebPage",
            name: "Emergency Contacts & Safety Information",
            description:
              "Emergency hotlines, evacuation centers, and disaster preparedness information for Barangay Dela Paz residents",
            url: "https://delapaz.gov.ph/emergency",
            breadcrumb: {
              "@type": "BreadcrumbList",
              itemListElement: [
                {
                ...
                },
                {
                  ...
                  position: 2,
                  name: "Emergency",
                  item: "https://delapaz.gov.ph/emergency",
                },
              ],
            },
            mainEntity: [
              {
                ...
                serviceType: "Security & Peace Keeping",
              },
              {
                "@type": "EmergencyService",
                name: "Police (PNP)",
                telephone: "(123) 456-7893",
                serviceType: "Emergency Police Response",
              },
              {
                "@type": "EmergencyService",
                name: "Fire Department (BFP)",
                telephone: "(123) 456-7894",
                serviceType: "Fire Emergency Response",
              },
              {
                "@type": "EmergencyService",
                name: "Health Center",
      ...
      <div className="py-12 px-4 md:px-8 max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border-2 border-[#0E58D8] text-center hover:shadow-xl transition-shadow">
              ...
              <a
                ...
                aria-label="Call Barangay Tanod emergency hotline"
              >
                Call Now
              </a>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border-2 border-blue-800 text-center hover:shadow-xl transition-shadow">
              ...
              <a
                ...
                aria-label="Call Police emergency hotline"
              >
                Call Now
              </a>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border-2 border-red-600 text-center hover:shadow-xl transition-shadow">
              <div className="w-20 h-20 bg-red-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <Flame size={40} className="text-white" aria-hidden="true" />
              </div>
              ...
              <a
                ...
                aria-label="Call Fire Department emergency hotline"
              >
                Call Now
              </a>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border-2 border-green-600 text-center hover:shadow-xl transition-shadow">
              <div className="w-20 h-20 bg-green-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <Heart size={40} className="text-white" aria-hidden="true" />
              </div>
              ...
              <a
                ...
                aria-label="Call Health Center emergency hotline"
              >
                Call Now
              </a>
            </div>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-2 mb-8">
            <Users size={32} className="text-[#0E58D8]" aria-hidden="true" />
              ...
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm border border-[#C4C4C4]">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-2">
                    <MapPin size={16} className="text-[#0E58D8] mt-0.5 flex-shrink-0" aria-hidden="true" />
                    <span className="text-[#333333]">{center.address}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Users size={16} className="text-[#0E58D8]" aria-hidden="true" />
                    <span className="text-[#333333]">Capacity: {center.capacity}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Phone size={16} className="text-[#0E58D8]" aria-hidden="true" />
